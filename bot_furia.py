# Importando a bibliblioteca dotenv para proteger o token do bot
import os
...
# Bot com o token do BotFather
bot = telebot.TeleBot('7268221173:AAEfGnjW2u6dWcGAoTb9ZcZgHQ4CViI69nk')
...
# Comando para mostrar o atual elenco da line de CS
...
def elenco(msg):
    bot.send_message(msg.chat.id, "Elenco atual da line de CS:\n\n"
                                  ...
                                  "1. hepa\n"
                                  "2. sidde\n")
# Comando para mostrar os próximos jogos
...
# Comando para mostrar os resultados de jogos recentes
...
# Comando para mostrar os campeonatos que a line está participando ou participará
...
# Comando para mostrar o winrate dos mapas
...
# Comando para mostrar o ranking atual da FURIA    
